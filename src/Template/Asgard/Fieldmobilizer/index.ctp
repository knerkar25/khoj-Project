...
<section class="content-header">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Field Mobilizer</h3>
        </div>
                        ...
                        <div class="row">
                            ...
                            <?php if ($role == 'COORDINATOR' || $role == 'CEO') : ?>
                                <div class="col-lg-6 col-sm-6 col-md-6 d-flex justify-content-end align-items-center">
                                    <a class="btn btn-accent fab-btn" href="<?= $this->Url->build(["controller" => "Fieldmobilizer", "action" => "add"]); ?>" data-toggle="tooltip" title="Add Admin">
                                        <i class="material-icons">add</i>
                                        <span>Add Field Mobilizer</span>
                                    </a>
                                </div>
                            <?php endif; ?>
                                            ...
                                            <?php if ($role == 'COORDINATOR' || $role == 'CEO') : ?>
                                                <td class="action-btn-container">
                                                    <div class="btn-group btn-group-sm d-flex justify-content-center" role="group" aria-label="Table row actions">
                                                        ...
                                                        <a href="<?= $this->Url->build(["controller" => "Fieldmobilizer", "action" => "delete", $val['id']]); ?>" type="button" class="btn btn-danger" data-toggle="tooltip" title="Delete Admin">
