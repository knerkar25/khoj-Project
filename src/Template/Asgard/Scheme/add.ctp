...
<section class="content-header">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
            ...
            <h3 class="page-title">Add Scheme</h3>
        </div>
                ...
                <div class="card-body p-0 pb-3">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" placeholder="Please Enter Name" class="form-control" required>
                        </div>

                        <div class="form-group">
                            <label for="description">Description</label>
                            <textarea name="description" placeholder="Please Enter Description" class="form-control" required></textarea>
                        </div>

                       

                        <div class="form-group mb-0 float-right">
                            <button type="submit" class="btn btn-accent sticky-action-btn">Add Scheme</button>
                        </div>
                        </form>
                    </div>
                </div>
