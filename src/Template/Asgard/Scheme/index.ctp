                ...
                <div class="p-0 text-center">
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="row">
                            ...
                            <?php if ($role == 'COORDINATOR' || $role == 'CEO' ) : ?>

                                <div class="col-lg-6 col-sm-6 col-md-6 d-flex justify-content-end align-items-center">
                                    <a class="btn btn-accent fab-btn" href="<?= $this->Url->build(["controller" => "Scheme", "action" => "add"]); ?>" data-toggle="tooltip" title="Add Department">
                                        ...
                                        <tr>
                                            ...
                                            <td class="action-btn-container">
                                                <div class="btn-group btn-group-sm " role="group" aria-label="Table row actions">
                                                    <a href="<?= $this->Url->build(["controller" => "Scheme", "action" => "view", $val['id']]); ?>" type="button" class="btn btn-white active-light" data-toggle="tooltip" title="View Department">
                                                        <i class="material-icons white">visibility</i>
                                                    </a>
                                                    <?php if ($role == 'COORDINATOR' || $role == 'CEO' ) : ?>

                                                        <a href="<?= $this->Url->build(["controller" => "Scheme", "action" => "edit", $val['id']]); ?>" type="button" class="btn btn-white active-light" data-toggle="tooltip" title="Edit Department">
                                                            <i class="material-icons"></i>
                                                        </a>
                                                        <a href="<?= $this->Url->build(["controller" => "Scheme", "action" => "delete", $val['id']]); ?>" type="button" class="btn btn-danger" data-toggle="tooltip" title="Delete Department">
