...
class VillageleaderController extends AppController
{
    ...
    public function index()
    {
        ...
        $details = $this->Users->find()->where(['Users.role' => 'VILLAGELEADER']);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($data['password'] != $data['rpassword']) {
                ...
                return $this->redirect(array('controller' => 'Villageleader', 'action' => 'add'));
            }
            ...
            if ($this->Query->setData('Users', $data)) {
                ...
                return $this->redirect(array('controller' => 'Villageleader', 'action' => 'index'));
            } else {
        ...
        $this->set('page_title', 'Add Villageleader');
    }
